            ...
            <form action="{{ route('front.review.store', $company->slug) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="move_type" class="form-control">
                        ...
                        <option value="interstate" {{ old('move_type') == 'interstate' ? 'selected' : '' }}>Interstate Move</option>
                        <option value="commercial" {{ old('move_type') == 'commercial' ? 'selected' : '' }}>Commercial Move</option>
                        <option value="specialty" {{ old('move_type') == 'specialty' ? 'selected' : '' }}>Specialty Move</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="e.g., Great service, highly recommend!" value="{{ old('title') }}" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Your Review <span class="required">*</span></label>
                    <textarea name="review" class="form-control" rows="6" placeholder="Share your detailed experience with this moving company..." required>{{ old('review') }}</textarea>
                ...
                <div class="form-group">
                    <div class="form-check">
                        ...
                        <input type="checkbox" name="would_recommend" value="1" class="form-check-input" id="recommend" {{ old('would_recommend') ? 'checked' : '' }}>
