  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-8">
        ...
        <p class="lead mb-4">Find reliable and professional moving services in {{ $stateName }}. Get free quotes from top-rated movers and save money on your move.</p>
        ...
        <div class="card h-100 shadow-sm border-0 hover-lift">
          <div class="card-body p-4">
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                <h5 class="fw-bold text-primary mb-0">{{ $mover->company->name ?? 'Moving Company' }}</h5>
          ...
          <div class="card-body p-4">
            <div class="d-flex align-items-start">
              ...
              <div class="flex-grow-1">
                ...
                <p class="text-muted small mb-2">{{ $company->city ?? 'City' }}, {{ $stateName }}</p>
                <div class="d-flex align-items-center mb-2">
                  <div class="text-warning me-2">
                    @for($i = 1; $i <= 5; $i++)
                      <i class="fas fa-star{{ $i <= ($company->rating ?? 4) ? '' : '-o' }}"></i>
                    @endfor
                  </div>
                  <span class="text-muted small">({{ $company->reviews_count ?? 0 }} reviews)</span>
                </div>
                <p class="text-muted small mb-3">{{ Str::limit($company->description ?? 'Professional moving services', 120) }}</p>
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-6 col-md-12">
        <div class="card h-100 shadow-sm border-0">
          ...
          <div class="card-body p-4">
            <h6 class="fw-bold text-primary mb-3">{{ $mover->company->name ?? 'Moving Company' }}</h6>
            <ul class="list-unstyled mb-3">
              <li class="mb-2"><i class="fas fa-check text-success me-2"></i>{{ $mover->point1 ?? 'Professional service' }}</li>
              <li class="mb-2"><i class="fas fa-check text-success me-2"></i>{{ $mover->point2 ?? 'Competitive pricing' }}</li>
              <li class="mb-2"><i class="fas fa-check text-success me-2"></i>{{ $mover->point3 ?? 'Full insurance coverage' }}</li>
              @if($mover->point4)
              <li class="mb-2"><i class="fas fa-check text-success me-2"></i>{{ $mover->point4 }}</li>
              @endif
            </ul>
            @if($mover->content)
            <div class="mb-3">
            ...
            @endif
            <div class="d-flex justify-content-between align-items-center">
              <span class="text-muted small">Deposit: {{ $mover->deposit_required ? 'Required' : 'Not Required' }}</span>
    ...
    <div class="row">
      <div class="col-lg-8 mx-auto">
        ...
        <div class="content-section">
          <p class="lead">Looking for reliable moving companies in {{ $stateName }}? You've come to the right place. Our platform connects you with professional movers who provide exceptional service and competitive pricing.</p>
          
          <h3 class="h4 fw-bold text-primary mt-4 mb-3">Why Choose {{ $stateName }} Movers?</h3>
          <ul class="list-unstyled">
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Licensed & Insured:</strong> All our movers are properly licensed and fully insured</li>
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Competitive Pricing:</strong> Get multiple quotes to find the best deal</li>
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Professional Service:</strong> Experienced crews handle your move with care</li>
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Full-Service Options:</strong> From packing to unpacking, we've got you covered</li>
          </ul>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="card border-0 shadow-sm">
                <div class="card-body">
                  <h5 class="fw-bold text-primary"><i class="fas fa-home me-2"></i>Residential Moves</h5>
                  <p class="small text-muted">Complete home relocation services including packing, loading, transportation, and unloading.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card border-0 shadow-sm">
                <div class="card-body">
                  <h5 class="fw-bold text-primary"><i class="fas fa-building me-2"></i>Commercial Moves</h5>
                  <p class="small text-muted">Office and business relocation with minimal downtime and professional handling.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card border-0 shadow-sm">
                <div class="card-body">
                  <h5 class="fw-bold text-primary"><i class="fas fa-route me-2"></i>Interstate Moves</h5>
                  <p class="small text-muted">Long-distance moving services across state lines with proper licensing and insurance.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card border-0 shadow-sm">
                <div class="card-body">
                  <h5 class="fw-bold text-primary"><i class="fas fa-box me-2"></i>Packing Services</h5>
                  <p class="small text-muted">Professional packing and unpacking services to protect your belongings.</p>
                </div>
              </div>
            </div>
          </div>
          
          <h3 class="h4 fw-bold text-primary mt-4 mb-3">How to Choose the Right {{ $stateName }} Mover</h3>
          <ol>
            <li class="mb-2"><strong>Get Multiple Quotes:</strong> Compare prices from at least 3 different companies</li>
            <li class="mb-2"><strong>Check Reviews:</strong> Read customer reviews and ratings</li>
            <li class="mb-2"><strong>Verify Licensing:</strong> Ensure the company is properly licensed and insured</li>
            <li class="mb-2"><strong>Ask Questions:</strong> Inquire about services, pricing, and policies</li>
            <li class="mb-2"><strong>Get Everything in Writing:</strong> Always get a written contract</li>
          </ol>
          
          <div class="alert alert-warning mt-4">
            <h5 class="alert-heading"><i class="fas fa-lightbulb me-2"></i>Pro Tip</h5>
            <p class="mb-0">Book your {{ $stateName }} mover at least 4-6 weeks in advance, especially during peak moving season (May-September).</p>
          </div>
        </div>
      </div>
    </div>
