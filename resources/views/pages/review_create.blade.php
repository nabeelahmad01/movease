...
@section('meta_description', 'Share your moving experience and help others find the best moving companies. Write honest reviews for moving companies you have used.')
@section('meta_keywords', 'moving company reviews, write review, moving experience, rate movers, moving company feedback')
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="input-group mb-3">
                        <input type="text" 
                               ...
                               id="companySearch" 
                               placeholder="Search for a moving company..."
        ...
        <div class="row g-4" id="companiesGrid">
            ...
            <div class="col-lg-4 col-md-6 company-item" 
                ...
                <div class="company-card">
                    ...
                    <p class="text-muted small">{{ Str::limit($company->description ?? 'Professional moving services', 100) }}</p>
