          ...
          <form method="GET" action="{{ route('front.get.quote') }}">
            <div class="row g-2">
              <div class="col-md-4">
                ...
                <input type="text" id="rc_zip_from" name="zip_from" class="form-control" placeholder="ZIP or City" required autocomplete="off">
              </div>
              <div class="col-md-4">
                <label class="form-label text-muted">Moving To*</label>
                <input type="text" id="rc_zip_to" name="zip_to" class="form-control" placeholder="ZIP or City" required autocomplete="off">
              </div>
              <div class="col-md-4">
                <label class="form-label text-muted">Moving Date</label>
                <input type="text" id="rc_move_date" name="move_date" class="form-control" placeholder="YYYY-MM-DD">
              </div>
              <div class="col-12">
