        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6">
                    ...
                    <p class="lead">MoveEase connects you with verified, licensed moving companies across the United
                        States. We understand that moving can be stressful, which is why we've created a platform that makes
                        finding reliable movers simple and transparent.</p>
                    <p>Our mission is to eliminate the guesswork from your moving experience by providing you with detailed
                        company profiles, genuine customer reviews, and competitive quotes from FMCSA-verified moving
                        professionals.</p>
                </div>
                <div class="col-lg-6">
                    <div class="text-center">
                        <i class="fas fa-truck-moving"
                            style="font-size: 8rem; color: var(--primary-color); opacity: 0.1;"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 mt-5">
                <div class="col-lg-4">
                    <div class="feature-card">
                        ...
                        <p>All moving companies on our platform are FMCSA verified and properly licensed to ensure your
                            peace of mind.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="feature-card">
                        ...
                        <h4>Real Reviews</h4>
                        <p>Read authentic reviews from real customers to make informed decisions about your moving company.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="feature-card">
                        ...
                        <h4>Free Quotes</h4>
                        <p>Get multiple quotes from qualified movers and compare prices to find the best deal for your move.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-4">Join thousands of satisfied customers who have found their perfect moving company
                        through MoveEase.</p>
