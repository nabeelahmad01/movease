        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="related-blog-card">
                    ...
                    <p class="text-muted">{{ Str::limit($relatedBlog->excerpt ?? 'Expert moving advice', 100) }}</p>
                    <div class="d-flex justify-content-between align-items-center">
                        <small class="text-muted">{{ $relatedBlog->created_at->format('M d, Y') }}</small>
                        <a href="{{ route('front.blog.detail', $relatedBlog->slug) }}" class="btn btn-sm">Read More</a>
                    </div>
                </div>
            </div>
            @endforeach
