...
@section('meta_description', 'Find reliable movers in ' . $cityName . ', ' . $stateName . '. Get free quotes from local moving companies. Professional ' . $cityName . ' moving services with competitive pricing.')
@section('meta_keywords', $cityName . ' movers, moving companies ' . $cityName . ' ' . $stateName . ', ' . $cityName . ' moving services, local movers ' . $cityName)
      ...
      <div class="col-lg-8">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('front.state.movers', ['state' => strtolower(str_replace(' ', '-', $stateName))]) }}" class="text-white">{{ $stateName }} Movers</a></li>
            <li class="breadcrumb-item active text-white" aria-current="page">{{ $cityName }} Movers</li>
          </ol>
        </nav>
        <h1 class="display-4 fw-bold mb-3">{{ $cityName }} Moving Routes</h1>
        <p class="lead mb-4">Find reliable and professional moving services in {{ $cityName }}, {{ $stateName }}. Get free quotes from local movers and save money on your move.</p>
            ...
            <form id="costCalculator">
              <div class="row g-4">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control zipto" id="calc_to" placeholder="Enter zip code" value="{{ $cityZip ?? '' }}">
                </div>
                <div class="col-md-6">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="card h-100 border-0 shadow-sm text-center">
          <div class="card-body p-4">
            ...
            <p class="text-muted small">Same-day and next-day moving services within {{ $cityName }}</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <h2 class="fw-bold text-primary mb-4">Moving Services in {{ $cityName }}, {{ $stateName }}</h2>
        <div class="content-section">
          <p class="lead">Looking for reliable moving companies in {{ $cityName }}, {{ $stateName }}? Our platform connects you with local movers who understand the unique challenges of moving in the {{ $cityName }} area.</p>
          
          <h3 class="h4 fw-bold text-primary mt-4 mb-3">Why Choose {{ $cityName }} Movers?</h3>
          <ul class="list-unstyled">
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Local Expertise:</strong> Movers familiar with {{ $cityName }} neighborhoods and regulations</li>
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Quick Response:</strong> Fast service for local moves within {{ $cityName }}</li>
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Competitive Pricing:</strong> Local rates without long-distance charges</li>
            <li class="mb-2"><i class="fas fa-check text-success me-2"></i><strong>Community Trust:</strong> Established movers with local reputation</li>
          </ul>
            ...
            <div class="accordion-item">
              ...
              <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Local moves in {{ $cityName }} typically cost between $200-$800 depending on the size of your home and distance. Use our cost calculator above for a more accurate estimate.
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  For local moves in {{ $cityName }}, we recommend booking 2-4 weeks in advance. During peak season (May-September), book 4-6 weeks ahead.
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Yes, most {{ $cityName }} moving companies offer professional packing services. This includes packing materials, labor, and unpacking at your new location.
                </div>
              </div>
            </div>
          </div>
