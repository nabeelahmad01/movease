                        ...
                        <form method="GET" action="{{ route('front.get.quote') }}">
                            <div class="row g-2">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="ri_zip_from" name="zip_from" class="form-control zipfrom"
                                        placeholder="ZIP or City" required autocomplete="off">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label text-muted">Moving To*</label>
                                    <input type="text" id="ri_zip_to" name="zip_to" class="form-control zipto"
                                        placeholder="ZIP or City" required autocomplete="off">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label text-muted">Moving Date</label>
                                    <input type="text" id="ri_move_date" name="move_date movedate" class="form-control"
    ...
    <section class="py-5">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('front.get.quote') }}" class="btn btn-outline-primary"><i
                        class="fas fa-quote-left me-2"></i>Get Free Quotes</a>
            </div>
