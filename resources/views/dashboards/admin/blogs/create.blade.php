...
<div class="container-fluid">
  <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data" class="card shadow-sm p-3">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-4"><label class="form-label">Slug (optional)</label><input name="slug" class="form-control"></div>
      ...
      <div class="col-md-4"><label class="form-label">Publish Date</label><input type="date" name="published_at" class="form-control"></div>
...
<script>
  tinymce.init({ selector: 'textarea[name=content]', height: 400, menubar:false });
</script>
@endpush
