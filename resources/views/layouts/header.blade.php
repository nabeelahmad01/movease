    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('/') ? 'active' : '' }}" href="{{ route('front.home') }}">Home</a>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="resourcesDropdown">
                        @if(!empty($headerBestPages) && $headerBestPages->count())
                            @foreach($headerBestPages as $hp)
                                <li><a class="dropdown-item" href="{{ route('front.best.moving', $hp->slug) }}">{{ $hp->page_name }}</a></li>
                            @endforeach
                            <li><hr class="dropdown-divider"></li>
                        @endif
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is('blog*') ? 'active' : '' }}" href="#" id="blogsDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Blogs
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="blogsDropdown">
                        ...
                        @if(!empty($headerBlogCategories) && $headerBlogCategories->count())
                            @foreach($headerBlogCategories as $cat)
                                <li><a class="dropdown-item" href="{{ route('front.blog.category', $cat->slug) }}">{{ $cat->name }}</a></li>
                            @endforeach
                        @endif
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('reviews*') ? 'active' : '' }}" href="{{ route('front.review.create') }}">Reviews</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('get-quote*') ? 'active' : '' }}" href="{{ route('front.get.quote') }}">Get Quote</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('about*') ? 'active' : '' }}" href="{{ route('front.about') }}">About</a>
                </li>
                <li class="nav-item">
